...
public class MapSpot implements Serializable{
	 ...
	 * @param showImage An Icon, the image to display
	 */
	 ...
	 * @param background the Image to set as the background
	 */
	 ...
	 * @param tState the TerrainState for this map location
	 */
	public void settState(TerrainState tState) {
		this.tState = tState;
	}
	/**
	 * Creates a new instance of MapSpot. Contains all information about each cell of the grid on the main screen.
	 * @param button The JButton at that spot on the map
	 * @param ts The TerrainState of that spot on the map
	 * @param img The background Image of that spot on the map
	 */
	...
	/**
	 * Creates a new instance of MapSpot. Contains all information about each cell of the gird on the main screen.
	 */
	public MapSpot() {
	 ...
	 * @param structure The Building being tested 
	...
	/**
	 * Overrides Object's equal method, sees if two MapSpots are equal. Based on the Building or TerrainState at the MapSpot.
