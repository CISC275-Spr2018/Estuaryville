...
public class Camera {
	...
	/**
	 * Creates an instance of the Camera class. This constructor assigns the x
	 * position and y position attributes of the Camera to place the camera at
	 ...
	 * 
	 * @param x
	 *            The speed to assign to the x speed attribute of the Camera.
	 */
	 ...
	 * 
	 * @param y
	 *            The speed to assign to the y speed attribute of the Camera.
	 */
	 ...
	 * 
	 * @param w
	 *            The value to set the width of the Camera to.
	 */
	 ...
	 * 
	 * @param h
	 *            The value to set the height of the Camera to.
	 */
