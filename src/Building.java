...
public class Building implements Serializable {
	 ...
	 * @param quality
	 *            The maximum pollution level allowed to build the building.
	 * @param name
	 *            The name of the building.
	 * @param filename
	 *            The name of the image file for the building.
	 */
	...
	/**
	 * Overrides Object's equal method, sees if two Buildings are equal. Based
	 * on the name.
	 * 
	 * @param obj
