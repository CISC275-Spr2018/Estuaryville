...
/**
 * The model of the main screen. Contains all information about the state of the
 * main screen.
 * 
 * @author Riley
 *
...
public class MainModel implements Serializable {
	...
	/**
	 * Returns a Map with the keys being the Building's name and the Value being
	 * the Building.
	 * 
	 * @return a Map with the keys being the Building's name and the Value being
	 *         the Building.
	 */
	 ...
	 * 
	 * @param map
	 *            the grid of MapSpots which forms the board displayed.
	 */
	 ...
	 * @param xPos
	 *            The x location to build.
	 * @param yPos
	 *            The y location to build.
	 * @return
	 */
	...
	public BuildReturn build(Building structure, int xPos, int yPos) {
		...
		if (build != BuildState.REMOVE && build != BuildState.NONE) {
			if (!placedBuildings[build.ordinal()] && isValidPlacement(xPos, yPos, structure)
					&& isConstructable(structure) && map[xPos][yPos].getB() == null) {
	 ...
	 * 
	 * @param xPos
	 *            The x position to remove building from.
	 * @param yPos
	 *            The y position to remove building from.
	 */
	...
	/**
	 * Checks to see if a building can be built with current money and pollution
	 * levels.
	 * 
	 * @param structure
	 ...
	 * 
	 * @param xPos
	 *            The x position to build building.
	 * @param yPos
	 *            The x position to build building.
	 * @param structure
	 *            The building to be built.
