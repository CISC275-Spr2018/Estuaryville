...
public enum BDirection {
	...
	/**
	 * Creates an instance of the BDirection enumeration. This constructor assigns
	 * a name to the BDirection of the Bird. 
	 * @param s The name to assign to the BDirection of the Bird. 
	 */
