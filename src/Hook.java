...
public class Hook extends Mover {
	...
	public Hook() {
		...
		hitbox = new Rectangle(getXPos(), getYPos() + FishingGameView.HOOK_HEIGHT / 3, FishingGameView.HOOK_WIDTH,
				FishingGameView.HOOK_HEIGHT * 2 / 3);
		gotABite = false;
	}
	 ...
	 * 
	 * @param b
	 *            a boolean, true if a fish is hooked
	 */
