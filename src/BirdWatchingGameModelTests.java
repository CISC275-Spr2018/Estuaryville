...
public class BirdWatchingGameModelTests {
	...
	public void eastRightBoundTest() {
		...
		testModel.getBirds().get(0).setXPos(testView.scaledBackground.getWidth() - 49); //outside of right boundary
	...
	public void eastInBoundsCheck() {
		testModel.getBirds().get(0).setDirection(BDirection.EAST);
		testModel.getBirds().get(0).setXPos(testView.background.getWidth() - 51); //inside of boundaries
		testModel.checkBounds(testModel.getBirds().get(0));
	...
	public void northeastInWidthBoundsCheck() {	
		testModel.getBirds().get(0).setDirection(BDirection.NORTHEAST);
		testModel.getBirds().get(0).setXPos(testView.getScreenWidth() - 51); //inside of width boundaries
		testModel.checkBounds(testModel.getBirds().get(0));
	...
	public void southeastBottomBoundTest() {	
		testModel.getBirds().get(0).setDirection(BDirection.SOUTHEAST);
		testModel.getBirds().get(0).setYPos(testView.getScreenHeight() - 49); //outside of bottom boundary
		testModel.checkBounds(testModel.getBirds().get(0));
	...
	public void cameraBottomBoundCheck() {	
		testModel.getCamera().setYPos(testView.getScreenHeight() - 349); //outside of bottom of screen
		testModel.checkBounds(testModel.getCamera());
	...
	public void cameraRightBoundCheck() {	
		testModel.getCamera().setXPos(testView.getScreenWidth() - 339); //outside of right of screen
		testModel.checkBounds(testModel.getCamera());
	...
	public void tutorialTakePictureTest() {
		BirdWatchingGameModel tstModel = new BirdWatchingGameModel(testView.getScreenWidth(), testView.getScreenHeight());
