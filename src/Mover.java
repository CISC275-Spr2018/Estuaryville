...
/**
 * This represents all the moving objects on the screen at a time and 
 * holds their attributes of position, speed, and direction.
 * @author Joel
 *
 */
public class Mover {
...
/* GETTERS & SETTERS */
	 ...
	 * @return an int, the number of pixels to the right of the left edge of the panel
	 */
	public int getXPos(){return xPos;}
	/**
	 * Updates the Mover's X position
	 * @param xp an int, the new X position
	 */
	 ...
	 * @param yp an int, the new Y position
	 */
